...
import wszib.project.shop.service.CategoryService;
...
public class HomeController {
    ...
    public String homePost(@RequestParam("categoryId") long categoryId, Model model){
        model.addAttribute("Phone", productService.findAllByCategoryId(categoryId));
        model.addAttribute("PhoneCount", productService.count());
        model.addAttribute("categories", categoryService.findAll());
        return "home";
    }
